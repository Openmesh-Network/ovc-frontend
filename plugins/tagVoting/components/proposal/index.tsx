...
import { getProposalStatusVariant } from "@/plugins/tagVoting/utils/proposal-status";
...
export default function ProposalCard(props: ProposalInputs) {
  const { proposal, status } = useProposal(props.plugin, props.proposalId);
  ...
  if (!proposal || showLoading) {
    ...
    return (
      <Link
        href={`#/${props.tag}/proposals/${props.proposalId}`}
